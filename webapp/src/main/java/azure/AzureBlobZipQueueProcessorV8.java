...
public class AzureBlobZipQueueProcessorV8 implements ZipQueueProcessor {
    ...
    public AzureBlobZipQueueProcessorV8(String cosmosAccountEndpoint, String cosmosAccountKey, String cosmosDatabase,
            String storageAccountCS, String cloudBlobContainer, String queueName) throws Exception {
        backgroundJob = new AzureBlobBackgroundJobV8(cosmosAccountEndpoint, cosmosAccountKey, cosmosDatabase,
                storageAccountCS, cloudBlobContainer);
        try {
