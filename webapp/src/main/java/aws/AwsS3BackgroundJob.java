...
public class AwsS3BackgroundJob implements BackgroundJob {
    ...
    public AwsS3BackgroundJob(String region, String accessKeyId, String secretAccessKey, String dynamoTable,
            String s3Bucket) {
        this(region, accessKeyId, secretAccessKey, dynamoTable, s3Bucket, 0, 0);
    }

    public AwsS3BackgroundJob(String region, String accessKeyId, String secretAccessKey, String dynamoTable,
            String s3Bucket, long cleanExpiredSeconds, long cleanGarbageSeconds) {
    ...
    public void clean() throws BackgroundJobException {
        ScanRequest scanReq = ScanRequest.builder().tableName(dynamoTable).limit(100).projectionExpression("sessionKey")
                .build();
