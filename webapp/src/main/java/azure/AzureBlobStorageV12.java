...
public class AzureBlobStorageV12 implements DataStorage {
    ...
    public AzureBlobStorageV12(int keyLength, String cosmosAccountEndpoint, String cosmosAccountKey,
            String cosmosDatabase, String storageAccountCS, String blobServiceContainer, String queueName,
            int maxFileCount, long maxFileSize, boolean useZipConverter) {
