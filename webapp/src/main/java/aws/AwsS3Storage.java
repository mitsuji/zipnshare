...
public class AwsS3Storage implements DataStorage {
    ...
    public AwsS3Storage(int keyLength, String region, String accessKeyId, String secretAccessKey, String dynamoTable,
            String s3Bucket, String sqsUrl, String sqsGroupId, int maxFileCount, long maxFileSize,
            boolean useZipConverter) {
    ...
    public void lockSession(String sessionKey) throws DataStorageException {
        ...
        dm.lock();
        if (useZipConverter) {
            SendMessageRequest req = SendMessageRequest.builder().queueUrl(sqsUrl).messageGroupId(sqsGroupId)
                    .messageBody(sessionKey).build();
