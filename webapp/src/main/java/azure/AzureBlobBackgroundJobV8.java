...
public class AzureBlobBackgroundJobV8 implements BackgroundJob {
    ...
    public AzureBlobBackgroundJobV8(String cosmosAccountEndpoint, String cosmosAccountKey, String cosmosDatabase,
            String storageAccountCS, String cloudBlobContainer) throws Exception {
        this(cosmosAccountEndpoint, cosmosAccountKey, cosmosDatabase, storageAccountCS, cloudBlobContainer, 0, 0);
    }

    public AzureBlobBackgroundJobV8(String cosmosAccountEndpoint, String cosmosAccountKey, String cosmosDatabase,
            String storageAccountCS, String cloudBlobContainer, long cleanExpiredSeconds, long cleanGarbageSeconds)
            throws Exception {
    ...
    public void clean() throws BackgroundJobException {
        try {
            ...
            CosmosPagedIterable<JsonNode> res = container.queryItems(sql, new CosmosQueryRequestOptions(),
                    JsonNode.class);
