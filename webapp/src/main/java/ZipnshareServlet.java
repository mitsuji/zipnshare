...
public class ZipnshareServlet extends DefaultServlet {
    ...
    private static void renderHtml(HttpServletRequest req, String localPath, Template.PlaceHolderHandler values,
    ...
    public void service(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        if (router.matches("POST", "/upload")) {
            ...
            try {
                ...
                // [TODO] 500
                ServletException ex1 = new ServletException(
                        messageBundle.getString("error.failed_to_render_share_page"), ex);
            ...
            try {
                ...
                // [TODO] 500
                ServletException ex1 = new ServletException(
                        messageBundle.getString("error.failed_to_response_zip_download_link"), ex);
            ...
            try {
                ...
                // [TODO] 500
                ServletException ex1 = new ServletException(
                        messageBundle.getString("error.failed_to_response_file_download_link"), ex);
            ...
            try {
                ...
                // [TODO] 500
                ServletException ex1 = new ServletException(
                        messageBundle.getString("error.failed_to_render_delete_page"), ex);
