    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (storageType.equals("localFile")) {
                ...
                zipQueueProcessor = new AzureBlobZipQueueProcessorV8(cosmosAccountEndpoint, cosmosAccountKey,
                        cosmosDatabase, storageAccountCS, cloudBlobContainer, queueName);
                cleanerBackgroundJob = new AzureBlobBackgroundJobV8(cosmosAccountEndpoint, cosmosAccountKey,
                        cosmosDatabase, storageAccountCS, cloudBlobContainer, cleanExpiredSeconds, cleanGarbageSeconds);
                ...
                String queueName = bundle.getString("zipnshare.queueName");
                zipQueueProcessor = new AzureBlobZipQueueProcessorV12(cosmosAccountEndpoint, cosmosAccountKey,
                        cosmosDatabase, storageAccountCS, blobServiceContainer, queueName);
                cleanerBackgroundJob = new AzureBlobBackgroundJobV12(cosmosAccountEndpoint, cosmosAccountKey,
                        cosmosDatabase, storageAccountCS, blobServiceContainer, cleanExpiredSeconds,
                        cleanGarbageSeconds);
                ...
                zipQueueProcessor = new AwsS3ZipQueueProcessor(region, accessKeyId, secretAccessKey, dynamoTable,
                        s3Bucket, sqsUrl, sqsGroupId);
                cleanerBackgroundJob = new AwsS3BackgroundJob(region, accessKeyId, secretAccessKey, dynamoTable,
                        s3Bucket, cleanExpiredSeconds, cleanGarbageSeconds);
            } else {
