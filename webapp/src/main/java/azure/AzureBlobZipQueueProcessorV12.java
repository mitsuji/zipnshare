...
public class AzureBlobZipQueueProcessorV12 implements ZipQueueProcessor {
    ...
    public AzureBlobZipQueueProcessorV12 (String cosmosAccountEndpoint, String cosmosAccountKey, String cosmosDatabase, String storageAccountCS, String blobServiceContainer,
					  String queueName) {
