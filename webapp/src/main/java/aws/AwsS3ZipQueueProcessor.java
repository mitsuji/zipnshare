...
public class AwsS3ZipQueueProcessor implements ZipQueueProcessor {
    ...
    public AwsS3ZipQueueProcessor(String region, String accessKeyId, String secretAccessKey, String dynamoTable,
            String s3Bucket, String sqsUrl, String sqsGroupId) {
    ...
    public void process() throws Exception {
        ReceiveMessageRequest req = ReceiveMessageRequest.builder().queueUrl(sqsUrl).maxNumberOfMessages(1).build();
        ...
        if (res.hasMessages()) {
            ...
            ChangeMessageVisibilityRequest reqCMV = ChangeMessageVisibilityRequest.builder().queueUrl(sqsUrl)
                    .receiptHandle(msg.receiptHandle()).visibilityTimeout(30 * 60) // 30 minutes
                    .build();
            ...
            if (succeed) {
                // [MEMO] delete message
                DeleteMessageRequest reqDel = DeleteMessageRequest.builder().queueUrl(sqsUrl)
